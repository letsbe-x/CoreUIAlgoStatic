<template>
  <v-card color="blue">
    <div class="page">
      ...
      <div style="color:white; min-height:5vh; display:flex; align-items:center; justify-content:center;">
          <vue-typed-js :strings="['awesome', 'nice', 'brilliant']" :loop="true">
          <h2>Algoria is a <span class="typing"></span> Service!</h2>
          </vue-typed-js>
      </div>
      <br/>
